...
APP_SERVICES="api-gateway api-auth api-employee api-employer api-admin api-jobs api-billing"
...
for svc in api-gateway api-auth api-employee api-employer api-admin api-jobs api-billing; do
